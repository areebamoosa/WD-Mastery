            ...
            <div className="grid grid-cols-6 mt-20 gap-x-6 m-15 ">
                ...
                <div>
                    <ul className="light text-xs font flex flex-col gap-4 ">
                        ...
                        <li className="blue-text "><a href="#" onClick={(e) => e.preventDefault()}>COURSES</a></li>
                ...
                <div>
                    <ul className="light text-xs font flex flex-col gap-4 ">
                        <li className="blue-text"><a href="#" onClick={(e) => e.preventDefault()}>YOUR JOURNEY</a></li>
                ...
                <div>
                    <ul className="light text-xs font flex flex-col gap-4 ">
                        <li className="blue-text" onClick={(e) => e.preventDefault()}><a href="#">RESOURCES</a></li>
                ...
                <div>
                    <ul className="light text-xs font flex flex-col gap-4 ">
                        <li className="blue-text"><a href="#" onClick={(e) => e.preventDefault()}>COMPANY</a></li>
