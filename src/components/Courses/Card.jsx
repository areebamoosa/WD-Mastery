...
const Card = ({ id, title, img, desc }) => {
  return (
    <>
      ...
      <Link to="#" >
        <div className="rounded-2xl p-4 border border-yellow-400 bg-[#0b0b2a] shadow-[0_0_20px_rgba(255,215,0,0.2)] hover:shadow-[0_0_25px_rgba(255,215,0,0.4)] hover:scale-[1.02] transition-all duration-300flex flex-col gap-2 items-start justify-start card sm:w-80 sm:h-80  w-80 md:w-90 ">
